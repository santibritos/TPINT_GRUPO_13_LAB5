...
<body>
		...
		<div class="contenedor">
		 <h1>Pacientes</h1>
			...
			<form action="altaP.html" method="post">
			<input class="btn btnAgregar" type="submit" value="Agregar" />
			</form>
				...
				<c:forEach var="paciente" items="${listaPacientes}">
					 <tr>
					  <td ><c:out value="${paciente.dni}" /></td>
	                    ...
	                    <td >
	                    <a href = "modificarPaciente${paciente.dni}.html"   class = "btn btnModificar" >Modificar</a>
	          			<a href = "borrarPaciente${paciente.dni}.html"   class = "btn btnBorrar" >Borrar</a>
	                   </td>
	                </tr>
